...
The table produced by `bib_tib_doc_author()` is structured as **one row = one document*author**. 

```{r tib_doc_author}
tib_doc_author=bib_tib_doc_author(tib_doc)
```
...
```{r tib_doc_keyword}
tib_doc_keyword=bib_tib_doc_keyword(tib_doc)
```
